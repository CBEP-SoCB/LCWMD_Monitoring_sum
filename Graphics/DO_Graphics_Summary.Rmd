...
Where:
*  Site-independent stream flow, and site-specific water temperature 
...
We filter out data from 2019 because that is only a partial year, which might
affect estimation of things like seasonal trends.  We could add it back in, but
with care.
...
and associating it with the model as `do_gamm$gam$call`. (See the `emmeans` 
...
high temperature or low flow events, especially at our shallow water sites.
